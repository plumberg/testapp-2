...
package com.brooklynwebcenter.maventest;
 ...
 * @author Shai Almog
 */
public class TestAppStub implements Runnable, WindowListener {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new TestAppStub());
    }
